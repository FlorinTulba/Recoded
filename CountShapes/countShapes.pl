...
%%% Scenario for figure 'count25651Shapes.png'
%scenarioFile('TestFigures/TextVersions/count25651shapes.png.txt'). % Generated by the figure interpreter written in Matlab/Octave
