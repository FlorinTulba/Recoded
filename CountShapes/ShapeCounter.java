...
public class ShapeCounter {
	 ...
	 */
	public ShapeCounter(String[][] lines) {
		lineMembers = new ArrayList<>(L = lines.length);
		TreeMap<String, Integer> pointsIndices = new TreeMap<>();
		for (int lineIdx = 0; lineIdx < L; ++lineIdx) {
			String[] line = lines[lineIdx];
			int pointsOnLine = line.length;
			...
			for (int pointRank = 0; pointRank < pointsOnLine; ++pointRank) {
				String pointName = line[pointRank];
				int pointIdx;
	...
	public static void main(String[] args) {
		...
		String lines[][] = { { "a", "c" }, { "a", "d" }, { "e", "f" }, { "b", "f", "d", "c" }, { "a", "e", "b" } };

		// Scenario from figure 'count9Shapes.png'
		//String lines[][] = { { "a", "c" }, { "b", "d", "f", "c" }, { "a", "e", "b" }, { "e", "g", "f" }, { "a", "g", "d" } };
		
		/*
		// Scenario from figure 'count100Shapes.png'
		String lines[][] = { { "a", "i" }, { "a", "b", "c", "d", "e" }, { "a", "n", "m", "l", "f" },
		...
		*/
		...
		String lines[][] = { { "a", "b", "c", "d", "e" }, { "a", "s", "t", "v", "w", "f" },
				{ "a", "r", "g1", "z", "i" }, { "a", "q", "f1", "d1", "c1", "l" }, { "a", "p", "o", "n", "m" },
				{ "b", "s", "r", "f1", "e1", "m" }, { "c", "t", "g1", "b1", "k" }, { "d", "u", "v", "x", "y", "i" },
				{ "e", "u", "t", "r", "q", "p" }, { "e", "v", "g1", "d1", "m" }, { "e", "w", "x", "z", "a1", "j" },
				{ "e", "f", "g", "h", "i" }, { "g", "x", "g1", "f1", "o" }, { "h", "y", "z", "b1", "c1", "m" },
